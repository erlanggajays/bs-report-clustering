...
def raw_sessions() -> list[dict]:
    ...
    return [
        ...
        },
        {
            ...
            "reason": "org.openqa.selenium.NoSuchElementException: Unable to locate element btn_confirm within 20000ms",
            "app_details": {"app_version": "6.7.0"},
        ...
        },
        {
            ...
            "device": "Samsung Galaxy S23",
            "reason": "org.openqa.selenium.NoSuchElementException: Unable to locate element field_amount within 20000ms",
            "app_details": {"app_version": "6.7.0"},
